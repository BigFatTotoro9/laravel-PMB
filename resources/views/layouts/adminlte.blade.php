        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li><a href="#"><i class="fa fa-circle-o text-aqua"></i> <span>Teknik Informatika</span></a>
                    </li>
                    <li><a href="#"><i class="fa fa-circle-o text-green"></i> <span>Sistem Informasi</span></a>
                    </li>
                    <li><a href="#"><i class="fa fa-circle-o text-yellow"></i> <span>Sistem Komputer</span></a>
                    </li>
                    <li><a href="#"><i class="fa fa-circle-o text-red"></i> <span>Manjemen & Bisnis</span></a>
                    </li>
